...
st.write("### Distribution of Bike Rentals")
fig, ax = plt.subplots(figsize=(10, 6))
sns.histplot(data['cnt'], kde=True, bins=30, color='blue', ax=ax)
ax.set_title('Distribution of Bike Rentals (cnt)', fontsize=14)
...
time_data = data.groupby('dteday')['cnt'].sum().reset_index()st.write("### Bike Rentals Over Time")
fig, ax = plt.subplots(figsize=(12, 6))
ax.plot(time_data['dteday'], time_data['cnt'], color='green')
ax.set_title('Bike Rentals Over Time', fontsize=14)
ax.set_xlabel('Date')
...
fig, ax = plt.subplots(figsize=(10, 6))
sns.boxplot(x='season', y='cnt', data=data, palette='Set3', ax=ax)
